...
window.USC_UNITS = [
  {slug:'u1-studio',   q:'u1',fmt:'studio',name:{ru:'Студия',ru_en:'Studio'},                    area:32, floor:{ru:'этаж 1–3',en:'floors 1–3'}, photos:['u1-21','u1-01','u1-03','u1-17','u1-16','u1-05','u1-22','u1-06']},
  ...
  {slug:'u2-1bd',      q:'u2',fmt:'1bd',   name:{ru:'1+1 спальня',ru_en:'1+1 bedroom'},           area:60, floor:{ru:'этаж 1–4',en:'floors 1–4'}, photos:['u2-1bd-04','u2-1bd-12','u2-1bd-05','u2-1bd-06','u2-1bd-11','u2-1bd-07','u2-1bd-10','u2-1bd-08','u2-1bd-02','u2-1bd-01']},
  {slug:'u2-2bd',      q:'u2',fmt:'2bd',   name:{ru:'2+1 спальни',ru_en:'2+1 bedrooms'},          area:89, floor:{ru:'этаж 2–3',en:'floors 2–3'}, photos:['u2-2bd-11','u2-2bd-14','u2-2bd-08','u2-2bd-10','u2-2bd-16','u2-2bd-09','u2-2bd-13','u2-2bd-17','u2-2bd-19','u2-2bd-20','u2-2bd-02','u2-2bd-23']},
  {slug:'u2-villa',    q:'u2',fmt:'villa', name:{ru:'Вилла 3+1 с бассейном',ru_en:'3+1 villa with pool'},area:200,floor:{ru:'2 этажа',en:'2 floors'}, photos:['u2-villa-31','u2-villa-02','u2-villa-32','u2-villa-05','u2-villa-04','u2-villa-13','u2-villa-08','u2-villa-12','u2-villa-17','u2-villa-26','u2-iphone-17','u2-iphone-27']},
